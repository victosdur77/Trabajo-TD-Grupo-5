...
intervalos=function(tabla,favorable=TRUE){
datos=funcion(tabla)
...
numf=nrow(final)
for(i in 1:(numf/2)){
    cat("La alternativa ",i," es la mejor para valores de alpha entre (", final$`Valores alpha`[i+(i-1)],",",final$`Valores alpha`[i*2],")","\n")
